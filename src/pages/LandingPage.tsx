        ...
        <div className="fixed inset-0 z-50 bg-slate-900 flex flex-col transition-transform duration-700 ease-in-out">
            ...
            <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 sm:px-6">
                <div className="max-w-4xl mx-auto space-y-8">
                    <div
                        className="inline-flex items-center gap-2 px-3 py-1 rounded-full glass-dark text-sky-300 text-xs font-medium uppercase tracking-wider mb-4 animate-slide-up delay-100"
                    >
                    ...
                    <h1
                        className="text-5xl sm:text-7xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#FFFDD0] to-[#D4AF37] leading-tight animate-slide-up delay-200"
                    >
                    ...
                    <p
                        className="text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed animate-slide-up delay-300"
                    >
                    ...
                    <div
                        className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8 animate-slide-up delay-400"
                    >
